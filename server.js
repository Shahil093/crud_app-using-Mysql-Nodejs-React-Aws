...
var con = mysql.createConnection({
  host: "nodedb.csmc2q1rzv6s.us-east-1.rds.amazonaws.com", // ip address of server running mysql
  user: "admin", // user name to your mysql database
  password: "shahil123", // corresponding password
  database: "cloud123" // use the specified database
});
